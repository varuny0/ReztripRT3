...
public class Mobile_CompoundAccessCode extends BaseTest  {
	...
	@FindAll({ @FindBy(xpath = "//div[@class='lyty-main']"), })
	
	public WebElement room_list;
	
	@FindAll({ @FindBy(xpath = "//*[contains(text(),'Available offers')]"), })
	...
	public void Entercode() {
		...
		if(Entercode.isDisplayed()) {
			Entercode.click();
		 cac = TC_CompoundAccessCodes.CompoundAccesscode;	
			System.out.println("CompoundAccesscode is "+cac);
			Entercode.sendKeys(cac);
			
			System.out.println("Able to enter the compound access code");
			Assert.assertTrue(true, "Able to enter the compound access code");
		}
		else {
			System.out.println("Unable to enter the compound access code");
			Assert.assertFalse(false, "Unable to enter the compound access code");
		}
	}
	...
	public void verifyselected_code() throws InterruptedException {
		...
		if(SelectedCode.contains(cac)) {
			
			System.out.println("Able to view " +cac);
	...
	System.out.println("Able to view the "+r3+" and "+r4+" rateplans");
