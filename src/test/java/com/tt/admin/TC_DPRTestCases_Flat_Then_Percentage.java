...
public class TC_DPRTestCases_Flat_Then_Percentage extends BaseTest
{
	...
	public void AddNewDPR_Discounttype_FlatAmount_DOW_AllDays(HashMap<String, String> h)
	{
		...
		//	login_Brand_Property();
			...
			test = extent.createTest("Add New DPR Using:DISCOUNT DEFINITION:Discount type: Flat Amount then Percentage :All Days");
			logger.info("Add New DPR Using:DISCOUNT DEFINITION:Discount type: Flat Amount then Percentage :All Days");
			...
			DPR.ReuseDPRFlat(RuleName,RuleCode,ShortDescription,"Flat Amount then Percentage", "Day Of Week", FlatAmount, SteadyDays, SteadyFlatAmount,DOW_ALL,RatePlan,NthNight,Percentage);
	...
	public void VerfiyinBE_AddNewDPR_Discounttype_FlatAmount_DOW(HashMap<String, String> h2) throws ParseException, IOException
	{
		...
		try 
		{
			...
			//clasicflow.ReuseMethodsforDPR(Enterrooms, roomtype, RatePlan,DPR.finalDay_Month_Date,RatePlan,FlatAmount,ShortDescription,SteadyDays,"Day Of Week",NthNight,"Flat Amount then Percentage",Percentage,FirstName,LastName,Email,Cardname,Numberoncard,Entercountry,Address, Enterzipcode, Address2, Enterstate, Entercity,Enterphonenum);
	...
	public void AddNewDPR_Discounttype_FlatAmount_DOW_particularDay(HashMap<String, String> h)
	{
		try 
		{
			...
			test = extent.createTest("Add New DPR Discount type: Flat Amount then Percentage : Day Of Week :particular Day");
			logger.info("Add New DPR Discount type: Flat Amount then Percentage : Day Of Week :particular Day");

			SeleniumRepo.driver.switchTo().window(ParentWindow);

			Discountprice=DPR.ReuseDPRFlat(RuleName,RuleCode,ShortDescription,"Flat Amount then Percentage", "Day Of Week", FlatAmount, SteadyDays, SteadyFlatAmount,DOW_AnyDay,RatePlan,NthNight,Percentage);
			
			SeleniumRepo.driver.switchTo().window(NewWindow);
			
			System.out.println(DPR.finalDay);
			
			//clasicflow.ReuseMethodsforDPR(Enterrooms, roomtype, RatePlan,DPR.finalDay_Month_Date,RatePlan,FlatAmount,ShortDescription,SteadyDays,"AnyDay",NthNight,"Flat Amount then Percentage",Percentage,FirstName,LastName,Email,Cardname,Numberoncard,Entercountry,Address, Enterzipcode, Address2, Enterstate, Entercity,Enterphonenum);
	...
	public void AddNewDPR_Discounttype_FlatAmount_First_N_Nights(HashMap<String, String> h)
	{
		try 
		{
			...
			test = extent.createTest("Add New DPR Discount type: Flat Amount then Percentage :First N Nights");
			logger.info("Add New DPR Discount type: Flat Amount then Percentage : Day Of Week :First N Nights");

			SeleniumRepo.driver.switchTo().window(ParentWindow);

			DPR.ReuseDPRFlat(RuleName,RuleCode,ShortDescription,"Flat Amount then Percentage", "First N Nights", FlatAmount, SteadyDays, SteadyFlatAmount,DOW_AnyDay,RatePlan,NthNight,Percentage);
			
			SeleniumRepo.driver.switchTo().window(NewWindow);
			
			//clasicflow.ReuseMethodsforDPR(Enterrooms, roomtype, RatePlan,DPR.finalDay_Month_Date,RatePlan,FlatAmount,ShortDescription,SteadyDays,"First N Nights",NthNight,"Flat Amount then Percentage",Percentage,FirstName,LastName,Email,Cardname,Numberoncard,Entercountry,Address, Enterzipcode, Address2, Enterstate, Entercity,Enterphonenum);
	...
	public void AddNewDPR_Discounttype_FlatAmount_Last_N_Nights(HashMap<String, String> h)
	{
		try 
		{
			...
			test = extent.createTest("Add New DPR Discount type: Flat Amount then Percentage :Last N Nights");
			logger.info("Add New DPR Discount type: Flat Amount then Percentage : Day Of Week :Last N Nights");

			SeleniumRepo.driver.switchTo().window(ParentWindow);
			
			DPR.ReuseDPRFlat(RuleName,RuleCode,ShortDescription,"Flat Amount then Percentage", "Last N Nights", FlatAmount, SteadyDays, SteadyFlatAmount,DOW_AnyDay,RatePlan,NthNight,Percentage);
			SeleniumRepo.driver.switchTo().window(NewWindow);
			
			//clasicflow.ReuseMethodsforDPR(Enterrooms, roomtype, RatePlan,DPR.finalDay_Month_Date,RatePlan,FlatAmount,ShortDescription,SteadyDays,"Last N Nights",NthNight,"Flat Amount then Percentage",Percentage,FirstName,LastName,Email,Cardname,Numberoncard,Entercountry,Address, Enterzipcode, Address2, Enterstate, Entercity,Enterphonenum);
	...
	public void AddNewDPR_Discounttype_FlatAmount_NthNight(HashMap<String, String> h)
	{
		try 
		{
			...
			test = extent.createTest("Add New DPR Discount type: Flat Amount then Percentage :Nth Night");
			logger.info("Add New DPR Discount type: Flat Amount then Percentage : Day Of Week :Nth Night");

			SeleniumRepo.driver.switchTo().window(ParentWindow);

			DPR.ReuseDPRFlat(RuleName,RuleCode,ShortDescription,"Flat Amount then Percentage", "Nth Night", FlatAmount, SteadyDays, SteadyFlatAmount,DOW_AnyDay,RatePlan,NthNight,Percentage);
			
			SeleniumRepo.driver.switchTo().window(NewWindow);
			
			//clasicflow.ReuseMethodsforDPR(Enterrooms, roomtype, RatePlan,DPR.finalDay_Month_Date,RatePlan,FlatAmount,ShortDescription,SteadyDays,"Nth Night",NthNight,"Flat Amount then Percentage",Percentage,FirstName,LastName,Email,Cardname,Numberoncard,Entercountry,Address, Enterzipcode, Address2, Enterstate, Entercity,Enterphonenum);
	...
	public void AddNewDPR_Discounttype_FlatAmount_AllNights(HashMap<String, String> h)
	{
		try 
		{
			...
			test = extent.createTest("Add New DPR Discount type: Flat Amount then Percentage :All Nights");
			logger.info("Add New DPR Discount type: Flat Amount then Percentage : Day Of Week :All Nights");

			SeleniumRepo.driver.switchTo().window(ParentWindow);

			
			DPR.ReuseDPRFlat(RuleName,RuleCode,ShortDescription,"Flat Amount then Percentage", "All Nights", FlatAmount, SteadyDays, SteadyFlatAmount,DOW_AnyDay,RatePlan,NthNight,Percentage);
			
			SeleniumRepo.driver.switchTo().window(NewWindow);
			
			//clasicflow.ReuseMethodsforDPR(Enterrooms, roomtype, RatePlan,DPR.finalDay_Month_Date,RatePlan,FlatAmount,ShortDescription,SteadyDays,"All Nights",NthNight,"Flat Amount then Percentage",Percentage,FirstName,LastName,Email,Cardname,Numberoncard,Entercountry,Address, Enterzipcode, Address2, Enterstate, Entercity,Enterphonenum);
			clasicflow.ReuseMethodsforDPRstart();
			classicFlowAvailPage.ReuseMethodsforDPRcheckavailabitlity(Enterrooms, roomtype);
			classicFlowReservationDet.ReuseMethodsforDPRsetupResDetails(RatePlan);
			clasicflow.ReuseMethodsforDPRclose(RatePlan,DPR.finalDay_Month_Date,RatePlan,FlatAmount,ShortDescription,SteadyDays,"Day Of Week",NthNight,"FlatAmount",FlatAmount,FirstName,LastName,Email,Cardname,Numberoncard,Entercountry,Address, Enterzipcode, Address2, Enterstate, Entercity,Enterphonenum);
